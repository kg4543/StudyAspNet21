...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <hr />
            <asp:HyperLink ID="LinkMemoList" runat="server" NavigateUrl="~/FrmMemoWrite.aspx">새글쓰기</asp:HyperLink>
            <asp:HyperLink ID="LinkMemoWrite" runat="server" NavigateUrl="~/FrmMemoList.aspx">리스트</asp:HyperLink>
        </div>
    </form>
</body>
</html>
