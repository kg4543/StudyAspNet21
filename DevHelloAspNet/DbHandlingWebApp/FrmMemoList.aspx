...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="BtnSearch" runat="server" Text="검색" OnClick="BtnSearch_Click" /> <br /><br />
            ...
            <hr />
            <asp:HyperLink ID="LinkMemoWrite" runat="server" NavigateUrl="~/FrmMemoWrite.aspx">새글쓰기</asp:HyperLink>
            <asp:HyperLink ID="LinkMemoList" runat="server" NavigateUrl="~/FrmMemoList.aspx">리스트</asp:HyperLink>
        </div>
    </form>
</body>
</html>
