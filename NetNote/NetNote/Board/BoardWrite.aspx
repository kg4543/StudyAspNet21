<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
         CodeBehind="BoardWrite.aspx.cs" Inherits="NetNote.Board.BoardWrite" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    padding: 5px; margin-left:auto; margin-right:auto;">
        ...
        <% if (!String.IsNullOrEmpty(Request.QueryString["Id"]) && 
            FormType == NetNote.Models.BoardWriteFormType.Modify) %>
        ...
        <td>
            ...
            <asp:Panel ID="pnlFile" runat="server" Width="480px" 
                ...
                <input id="txtFileName" style="width: 290px; 
                    height: 35px" type="file" name="txtFileName" runat="server">
    ...
    <% 
        if (!Page.User.Identity.IsAuthenticated) //로그인한 아이디가 없으면
        {
    %>
    <tr>
        <td style="text-align: right; padding-right=5px">
